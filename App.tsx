...
function WhatsAppButton() {
  return (
    <motion.a
      href="https://wa.me/15551234567?text=Hi! I'd like to order a cake from Sweet Delights"
      target="_blank"
      ...
      <main className="flex-1">
        <AnimatePresence mode="wait">
          <Routes location={location} key={location.pathname}>
            ...
            <Route path="/cake-builder" element={<PageTransition><CakeBuilder /></PageTransition>} />
